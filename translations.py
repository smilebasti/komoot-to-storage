...
TRANSLATIONS = {
    'en': {
        ...
        'step3_desc': 'Download or save to S3, NFS, SMB',
        'step4_title': '4. Done!',
        ...
        'download_desc': 'Download GPX files as ZIP directly to your device',
        ...
        'webdav_url_hint': 'For Nextcloud: https://your-server.com/remote.php/dav/files/username/',
    ...
    'de': {
        ...
        'step3_desc': 'Herunterladen oder auf S3, NFS, SMB speichern',
        ...
        'download_title': 'Download',
        'download_desc': 'GPX-Dateien als ZIP direkt auf dein Gerät herunterladen',
        ...
        'webdav_url_label': 'WebDAV-URL',
        'webdav_url_hint': 'Für Nextcloud: https://dein-server.de/remote.php/dav/files/benutzername/',
        ...
        # Progress indicator
        'progress_hint': 'Große Exports mit vielen Touren können mehrere Minuten dauern.',
        ...
        'export_name_desc': 'Ordnername für exportierte Dateien',
        ...
        'health_desc': 'Health-Check Endpoint. Gibt den Service-Status und die Version zurück.',
        'error_responses': 'Fehler-Responses',
        'status_code': 'Status Code',
        'error_400': 'Bad Request - Fehlende Pflichtfelder oder ungültiges JSON',
        'error_429': 'Too Many Requests - Rate Limit überschritten',
